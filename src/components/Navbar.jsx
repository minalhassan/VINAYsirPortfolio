        ...
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative z-10">
          ...
          <div className="hidden md:block">
            <button 
              ...
              className="relative px-6 py-2.5 rounded-full overflow-hidden group bg-transparent border border-white/20 text-white text-sm font-medium tracking-wider hover:border-white/60 transition-colors duration-300 cursor-pointer"
            >
      ...
      >
        <div className="flex flex-col space-y-8 text-center mt-10">
          ...
          <button 
            ...
            className="mt-8 px-8 py-3 rounded-full border border-white text-white tracking-widest hover:bg-white hover:text-black transition-all duration-300 cursor-pointer"
          >
            Contact
          </button>
        </div>
