        ...
        >
          ...
          <div className="flex-1 max-w-lg lg:max-w-xl text-left">
            <p className="text-sm md:text-base text-gray-300 font-medium tracking-widest uppercase mb-6 opacity-90 drop-shadow-md">
              Dr. Vinay Bhardwaj, Ph.D.
            </p>
            
            <h1 className="text-2xl md:text-3xl lg:text-[3rem] xl:text-[3.5rem] font-bold tracking-tighter drop-shadow-2xl leading-[1.05] font-sans">
              Associate Professor<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-200 to-gray-500 font-serif italic font-light pr-2">Cybersecurity</span> &<br />
              UAV Networks
            </h1>
          </div>
          ...
          <div className=" flex-1 max-w-md text-left md:text-right flex flex-col md:items-end">
            <p className="w-110 text-lg md:text-xl text-gray-300 drop-shadow-xl font-light tracking-wide leading-relaxed mb-8">
              Associate Professor at Lovely Professional University, Punjab. Researcher specializing in Vulnerability Assessment, Network Security, and Flying Ad-hoc Networks (FANETs).
            </p>
            
            <div className="flex flex-wrap gap-4 justify-start md:justify-end">
              <button 
                onClick={() => document.getElementById('projects')?.scrollIntoView({ behavior: 'smooth' })}
                className="pointer-events-auto px-8 py-4 rounded-full border border-white/30 text-white text-sm tracking-[0.2em] uppercase font-medium hover:bg-white hover:text-black hover:border-white transition-all duration-500 backdrop-blur-sm shadow-xl cursor-pointer"
              >
                View Research
              </button>
              
              <a 
                href="/Vinay_Bhardwaj_CV.pdf" 
                download="Dr_Vinay_Bhardwaj_CV.pdf"
                className="pointer-events-auto px-8 py-4 rounded-full bg-red-600 hover:bg-red-700 text-white text-sm tracking-[0.2em] uppercase font-medium transition-all duration-500 shadow-xl cursor-pointer inline-flex items-center gap-2"
              >
