    ...
    >
      ...
      <div className="max-w-2xl w-full relative z-10 flex flex-col items-center text-center">
        ...
        <div className="mb-12 animate-element">
          ...
          <p className="text-gray-400 font-light text-lg tracking-wide leading-relaxed max-w-xl mx-auto mb-8">
            Have inquiries regarding research collaboration, academic opportunities, or cybersecurity consulting? Drop a line via the secure form below or reach out directly through the verified communication channels.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full mb-12 animate-element">
          ...
          <a href="https://www.linkedin.com/in/dr-vinay-bhardwaj-54a313298/" target="_blank" rel="noopener noreferrer" className="p-4 rounded-xl bg-white/5 border border-white/10 hover:border-red-500/30 transition-all duration-300 flex flex-col items-center">
            ...
            <span className="text-sm font-light text-gray-300 truncate w-full text-center">dr-vinay-bhardwaj</span>
          </a>
        </div>
